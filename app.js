...
app.get('/.well-known/acme-challenge/BDot1Mtvc59o0-pzXlWR41iOutxHnsO4YpI0szpWOjg', (req, res) => {
    res.send('BDot1Mtvc59o0-pzXlWR41iOutxHnsO4YpI0szpWOjg.6UHAUVC8-p-RiWRA8RQXVq3ZjA9JpjiGrXNhhk4FnPo');
});
